...
- **Introduction to BCI and EEG**
  ...
  - [Watch the videos here](https://www.youtube.com/playlist?list=PLbbCsk7MUIGcO_lZMbyymWU2UezVHNaMq){target='_blank_'}

```{=html}
<p align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?si=HkC4WH7ccN4SG96f&amp;list=PLbbCsk7MUIGcO_lZMbyymWU2UezVHNaMq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></p>
```
...
- **General Neural Time-Series Analysis**
  ...
  - [Watch the videos here](https://youtube.com/playlist?list=PLn0OLiymPak1b2aYULx6hDVU7wSGEUJqw&si=6cfahgmQUQSKUi9O){target='_blank_'}


```{=html}
<p align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?si=4_utwpQ0UcDT6mwc&amp;list=PLn0OLiymPak1b2aYULx6hDVU7wSGEUJqw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></p>
```
...
- **Brain-Computer Interfacing: An Introduction** by Rajesh P.N. Rao
  ...
  - [Access the book](https://search.ebscohost.com/login.aspx?direct=true&db=cat09682a&AN=osl.oai.edge.okstate.folio.ebsco.com.fs00001145.6d5e45a6.e837.54f2.8a42.fb96031e01fb&site=eds-live&scope=site&custid=s1181350&group=main&profid=eds&authtype=ip,guest){target='_blank_'}
...
- [Video tutorials on MNE python](https://youtube.com/playlist?list=PLXtvZiGkmNVvPS0N9UNBVkIFe0_0t_Nqt&si=tsDV8bZOc7UNEPAg){target='_blank_'}
- [Official MNE tutorials](https://mne.tools/stable/auto_tutorials/index.html){target='_blank_'}

:::{.callout-note title=Task}
1. Explore basic EEG processing tutorials here: [EEG Tutorials](https://alexenge.github.io/intro-to-eeg/ipynb/1-python.html){target='_blank_'}
2. For more detailed tutorials go through the tutorials and implement standard functions using the EEG data in [MNE website](https://mne.tools/stable/auto_tutorials/index.html){target='_blank_'}. Reach out to Hemanth to get the EEG data.
:::
...
- **Overview and Importance**
  ...
  - [Learn about pylsl](https://github.com/labstreaminglayer/pylsl){target='_blank_'}